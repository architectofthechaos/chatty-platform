...
class MessageCreateRequest(BaseModel):
    ...
    parent_message_id: str | None = Field(None, description="ID of parent message (required if is_reply=True)")
...
class MessageResponse(BaseModel):
    ...
    parent_message_id: str | None = Field(None, description="ID of parent message")
